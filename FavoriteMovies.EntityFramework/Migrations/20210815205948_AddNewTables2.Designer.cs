...
namespace FavoriteMovies.EntityFramework.Migrations
{
    ...
    [Migration("20210815205948_AddNewTables2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.Director", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.Writer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.MovieAndActor", b =>
                {
                    b.HasOne("FavoriteMovies.Domain.Models.Actor", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.MovieAndDirector", b =>
                {
                    b.HasOne("FavoriteMovies.Domain.Models.Director", "Director")
                        .WithMany()
            ...
            modelBuilder.Entity("FavoriteMovies.Domain.Models.MovieAndWriter", b =>
                {
                    ...
                    b.HasOne("FavoriteMovies.Domain.Models.Writer", "Writer")
                        .WithMany()
